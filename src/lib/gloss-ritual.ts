...
export function resolveMirrorScene(ids: RitualIngredientId[]): MirrorScene {
  ...
  const scenes: Record<RitualIngredientId, MirrorScene> = {
    lift: { src: "/images/gloss/lash-lifting.png", objectPosition: "center 28%" },
    laminate: { src: "/images/gloss/brow-bar.png", objectPosition: "center 24%" },
    glow: { src: "/images/gloss/kosmetologie.png", objectPosition: "center 32%" },
    volume: { src: "/images/gloss/prodluzovani-ras.png", objectPosition: "center 26%" },
  };
